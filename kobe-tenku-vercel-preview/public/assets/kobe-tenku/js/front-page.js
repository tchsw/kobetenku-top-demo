document.addEventListener('DOMContentLoaded',()=>{
  ...
  const mapData={
    'ground':{title:'グラウンド',image:imageUrl('map-ground.jpg'),alt:'山と空に囲まれた神戸天空のグラウンド',text:'森と空にひらかれたグラウンド。季節の風を感じながら、運動や自然を生かした催しに利用できるエリアです。'},
    'atago-shrine':{title:'愛宕神社',image:imageUrl('map-atago-shrine.jpg'),alt:'森の中にたたずむ愛宕神社',text:'静かな森に佇む神社。',note:'※通常時は立ち入れません'},
    'atago-pond':{title:'愛宕池',image:imageUrl('map-atago-pond.jpg'),alt:'山の緑に囲まれた愛宕池',text:'鷺の住む穏やかな池。',note:'※通常時は立ち入れません'},
    'ginga-onsen':{title:'銀河の湯',image:imageUrl('map-ginga-onsen.png'),alt:'陽光に照らされる銀河の湯の露天風呂',text:'丹生山田に湧く源泉で、頭上に広がる空と遠い街並みを眺めながら爽やかな風と四季の音に浸れます。'},
    'glamping':{title:'グランピングエリア',image:imageUrl('map-glamping.png'),alt:'山並みを望む白いグランピングドームとデッキ',text:'白いドームが並ぶ山上の滞在エリア。宿泊はもちろん、気軽に自然を楽しめるデイグランピングもご用意しています。'},
    'cafe-lounge':{title:'カフェラウンジ',image:imageUrl('map-cafe-lounge.png'),alt:'グランピングドームを望むカフェラウンジの店内',text:'山上の景色を眺めながら、滞在の合間にひと息。季節と時間で変わる空を、ゆったり味わえる場所です。'},
    'spa-suite':{title:'スパスイートエリア',image:imageUrl('dusk.jpg'),alt:'夕暮れの空と白いドーム',text:'自然の中でプライベートな時間を大切にできる滞在エリア。夕焼けや星空とともに、静かなひとときを楽しめます。'},
    'dog-run':{title:'ドッグラン',image:imageUrl('map-dog-run.jpg'),alt:'山に囲まれた芝生のドッグラン',text:'愛犬と一緒に山上の空気を楽しめる屋外エリア。大きな空の下で、のびのびと過ごせます。'},
    'tennis-court':{title:'テニスコート',image:imageUrl('map-tennis-court.jpg'),alt:'緑の山々に囲まれたテニスコート',text:'緑豊かな環境に設けられたテニスコート。フリスビーなどのアクティビティもご用意しております。'}
  };
